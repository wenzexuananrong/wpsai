 ...
 * @since 1.3.4
 */
class Total_Unclaimed_Gift_Cards_Count extends Abstract_Report_Widget {
    /*
    |--------------------------------------------------------------------------
    | Class Methods
    |--------------------------------------------------------------------------
    */
    ...
    public function __construct( $report_period ) {
        ...
        $this->widget_name = __( 'Total Unclaimed Gift Cards', 'advanced-gift-cards-for-woocommerce' );
        $this->type        = 'big_number';
        $this->description = __( 'Total Unclaimed Gift Cards', 'advanced-gift-cards-for-woocommerce' );
    }
    ...
    */
    ...
    protected function _query_report_data() {
        ...
        $this->raw_data  = (int) $gift_card_stats['total_unclaimed_count'];
    }
