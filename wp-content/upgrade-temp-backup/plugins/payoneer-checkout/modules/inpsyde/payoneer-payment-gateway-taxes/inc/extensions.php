...
return
    ...
    static function (): array {
        return [
            'inpsyde_logger.log_events' => static function (
                array $previous
            ): array {
                ...
                $logEventsToAdd = [
                    ...
                    //],
                    [
                        'name' => 'payoneer-checkout.taxes_not_enabled',
                        'log_level' => LogLevel::INFO,
                        'message' => "Taxes are not enabled in WooCommerce settings.",
                    ],
                    [
                        'name' => 'payoneer-checkout.invalid_tax_configuration',
                        'log_level' => LogLevel::NOTICE,
                        'message' =>
                            'Payoneer Checkout detected an invalid tax configuration: {message}',
                    ],
                ];
