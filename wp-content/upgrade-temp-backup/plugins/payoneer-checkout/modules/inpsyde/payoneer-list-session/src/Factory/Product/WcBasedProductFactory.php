...
namespace Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product;
...
class WcBasedProductFactory implements WcBasedProductFactoryInterface
{
    ...
    public function createProductFromWcProduct(
        ...
        return $this->productFactory->createProduct(
            ...
            wp_strip_all_tags(htmlspecialchars_decode($serializedProduct['description'])),
            $this->taxCodeProvider->provideProductTaxCode($wcProduct)
        );
    }
}
