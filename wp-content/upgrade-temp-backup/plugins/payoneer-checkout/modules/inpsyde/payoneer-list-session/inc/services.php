...
use Inpsyde\PayoneerForWoocommerce\Checkout\ProductTaxCodeProvider\ProductTaxCodeProviderInterface;
use Inpsyde\PayoneerForWoocommerce\Checkout\TransactionIdGenerator\TransactionIdGeneratorInterface;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Customer\WcBasedCustomerFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Customer\WcBasedCustomerFactoryInterface;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\ListSession\OrderBasedListCommandFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\ListSession\OrderBasedListSessionFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\ListSession\WcBasedListSessionFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product\QuantityNormalizer;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product\QuantityNormalizerInterface;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product\WcBasedProductFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product\WcBasedProductFactoryInterface;
use Inpsyde\PayoneerForWoocommerce\ListSession\Factory\Product\WcCartBasedProductListFactory;
use Inpsyde\PayoneerForWoocommerce\ListSession\ListSession\ApiListSessionProvider;
use Inpsyde\PayoneerForWoocommerce\ListSession\ListSession\ListSessionManager;
use Inpsyde\PayoneerForWoocommerce\ListSession\ListSession\ListSessionManagerProxy;
use Inpsyde\PayoneerForWoocommerce\ListSession\ListSession\NoopListSessionPersistor;
use Inpsyde\PayoneerForWoocommerce\ListSession\Middleware\UpdatingMiddleware;
use Inpsyde\PayoneerForWoocommerce\ListSession\Middleware\WcOrderMiddleware;
use Inpsyde\PayoneerForWoocommerce\ListSession\Middleware\WcSessionMiddleware;
...
return static function (): array {
    return [
        'list_session.wc_based_customer_factory' => new Constructor(
        ...
        'list_session.order_based_list_command_factory' =>
            new Constructor(OrderBasedListCommandFactory::class, [
                ...
                'list_session.list_session_system',
                'wp.current_locale.normalized',
                'checkout.merchant_division',
            ]),

        'list_session.order_based_list_session_factory' => new Constructor(
        ...
        'list_session.list_session_factory' => new Factory(
            [
                'core.payoneer',
                'core.callback_factory',
                'core.style_factory',
                'core.payment_factory',
                'list_session.wc_based_customer_factory',
        ...
        'list_session.quantity_normalizer' => new Constructor(
            QuantityNormalizer::class
        ),

        'list_session.wc_based_product_factory' => static function (
        ...
        'list_session.wc_cart_based_product_list_factory' =>
            new Constructor(
                ...
                [
                    'list_session.wc_based_product_factory',
                    'checkout.product_factory',
                    'checkout.store_currency',
                ]
            ),

        'list_session.integration_type' => new Factory(
            ['list_session.selected_payment_flow'],
            static function (string $selectedPaymentFlow): string {
                return $selectedPaymentFlow === 'hosted' ?
                    PayoneerIntegrationTypes::HOSTED :
        ...
        'list_session.default_persistor' => new Constructor(
            NoopListSessionPersistor::class,
            [
            ]
        ),

        'list_session.creator' => new Constructor(
            ApiListSessionProvider::class,
            [
                'list_session.list_session_factory',
                'list_session.order_based_list_session_factory',
                'list_session.integration_type',
                'list_session.hosted_version',
            ]
        ),

        'list_session.middlewares.wc-order' => new Constructor(
            WcOrderMiddleware::class,
            [
        ...
        'list_session.middlewares.wc-session' => new Constructor(
            WcSessionMiddleware::class,
            [
                'wc.session',
        ...
        'list_session.middlewares.wc-session-update' => new Constructor(
            UpdatingMiddleware::class,
            [
                'list_session.manager.proxy',
                'list_session.list_session_factory',
        ...
        'list_session.manager' => new Constructor(
            ListSessionManager::class,
            ['list_session.middlewares']
        ),
