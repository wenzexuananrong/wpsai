...
use Inpsyde\Logger\Exception\CouldNotWriteToLogException;
...
class NativePhpLogger extends AbstractLogger
{
    ...
    protected function writeToLog(string $level, string $message, array $context = []): void
    {
        ...
        if (! $success) {
            throw new CouldNotWriteToLogException(
                'Failed writing to the log. Please, check your file permissions and logging settings.'
            );
        }
    }
