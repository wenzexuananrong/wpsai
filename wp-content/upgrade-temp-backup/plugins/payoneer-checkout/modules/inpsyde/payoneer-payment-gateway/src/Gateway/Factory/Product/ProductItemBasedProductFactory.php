...
class ProductItemBasedProductFactory extends AbstractOrderItemBasedProductFactory implements ProductItemBasedProductFactoryInterface
{
    ...
    public function __construct(
        ...
        int $priceDecimals,
        ProductTaxCodeProviderInterface $taxCodeProvider
    ) {
    ...
    public function createProduct(
        ...
        $amount = (float) wc_format_decimal($productItem->get_total(), $this->priceDecimals) +
                  (float) wc_format_decimal($productItem->get_total_tax(), $this->priceDecimals);
        /**
        ...
        return $this->productFactory->createProduct(
            ...
            $productImageUrl,
            wp_strip_all_tags(htmlspecialchars_decode($description)),
            $this->taxCodeProvider->provideProductTaxCode($product)
        );
    }
}
