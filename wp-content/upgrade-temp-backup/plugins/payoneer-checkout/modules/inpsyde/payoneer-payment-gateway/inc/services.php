    ...
    static function (): array {
        ...
        return [
            ...
            'inpsyde_payment_gateway.module_name' =>
                new Value('payoneer-payment-gateway'),
            ...
            'inpsyde_payment_gateway.wc_product_serializer' => new Constructor(
                WcProductSerializer::class
            ),
                ...
                static function (ContainerInterface $container): callable {
                    return
                        ...
                        static function (array $credentials) use ($container) {
                            ...
                            $division = ! empty($credentials['division']) ?
                            (string)$credentials['division'] :
                            '';
            ...
            'inpsyde_payment_gateway.fn.map' =>
                new Factory([], static function (): callable {
                    return
                        /**
             ...
             */
            'inpsyde_payment_gateway.path.assets' => new StringService(
                '{0}/{1}/assets',
                [
