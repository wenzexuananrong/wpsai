...
class Plugin_Constants {
    ...
    public function __construct( Abstract_Main_Plugin_Class $main_plugin = null ) {
        ...
        $this->_data = array(
            ...
            'OPTION_LICENSE_EXPIRED'                 => 'agcfw_license_expired',
            ...
            'OPTION_LAST_LICENSE_CHECK'              => 'agc_last_license_check',
            'SOFTWARE_KEY'                           => 'AGC',
            'NO_LICENSE_NOTICE_DISMISSED'            => 'agc_slmw_no_license_notice_dismissed',
            'LICENSE_DISABLED_NOTICE_DISMISSED'      => 'agc_license_disabled_notice_dismissed',
            'LICENSE_EXPIRE_NOTICE_DISMISSED'        => 'agc_license_expire_notice_dismissed',
            'LICENSE_PRE_EXPIRE_NOTICE_DISMISSED'    => 'agc_license_pre_expire_notice_dismissed',
            'NO_LICENSE_REMINDER_DISMISSED'          => 'agc_no_license_reminder_dismissed',
    ...
    public function get_license_page_url() {
        if ( is_multisite() ) {
            $license_page_link = current_user_can( 'manage_network_plugins' ) ? network_admin_url( 'admin.php?page=advanced-coupons&tab=agc_license' ) : '';
        } else {
            $license_page_link = admin_url( 'admin.php?page=acfw-license&tab=AGC' );
        }
