<?php
namespace AGCFW\Models\SLMW\Traits;
...
trait Notices {
    ...
    */
    ...
    public function display_no_license_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'       => 'agc-no-license-interstitial',
                'title'           => __( 'Your Advanced Gift Cards license is missing!', 'advanced-gift-cards-for-woocommerce' ),
                'action_url'      => $this->_constants->get_license_page_url(),
                'action_text'     => __( 'Enter Licenses Now', 'advanced-gift-cards-for-woocommerce' ),
                'sub_action_url'  => $this->_add_drm_query_args( 'https://advancedcouponsplugin.com/pricing/', 'interstitialpurchaselink' ),
                'sub_action_text' => __( 'Don’t have a license yet? Purchase here.', 'advanced-gift-cards-for-woocommerce' ),
            )
        );
    }
    ...
    */
    ...
    public function display_disabled_license_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'       => 'agc-disabled-license-interstitial',
                'title'           => __( 'Your Advanced Gift Cards license is disabled!', 'advanced-gift-cards-for-woocommerce' ),
                'action_url'      => $this->_add_drm_query_args( 'http://advancedcouponsplugin.com/my-account/pricing/', 'disabledinterstitial' ),
                'action_text'     => __( 'Repurchase New License', 'advanced-gift-cards-for-woocommerce' ),
                'sub_action_url'  => $this->_constants->get_license_page_url(),
                'sub_action_text' => __( 'Enter a new license', 'advanced-gift-cards-for-woocommerce' ),
            )
        );
    }
    ...
    */
    ...
    public function display_post_expiry_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'            => 'agc-license-expired-interstitial',
                'title'                => __( 'Your Advanced Gift Cards license has expired!', 'advanced-gift-cards-for-woocommerce' ),
                'action_url'           => $this->_add_drm_query_args( $license_data['management_url'] ?? 'http://advancedcouponsplugin.com/my-account/downloads/', 'expiredinterstitial' ),
                'action_text'          => __( 'Renew License', 'advanced-gift-cards-for-woocommerce' ),
                'sub_action_url'       => $this->_constants->get_license_page_url(),
                'sub_action_text'      => __( 'Enter a new license', 'advanced-gift-cards-for-woocommerce' ),
    ...
    public function ajax_dismiss_license_notice() {
        ...
        $post_data = $this->_helper_functions->validate_ajax_request(
            array(
                ...
                'nonce_action'        => 'agcfw_dismiss_license_notice',
    ...
    private function _display_interstitial( $args ) {
        ...
        $args             = wp_parse_args(
            ...
            array(
                'classname'            => '',
                'title'                => '',
                'description'          => __( 'Without an active license, your gift card codes in the front end will still continue to work, but premium functionality has been disabled until a valid license is entered.', 'advanced-gift-cards-for-woocommerce' ),
                'action_url'           => '',
                'action_text'          => '',
                'sub_action_url'       => '',
                'sub_action_text'      => '',
