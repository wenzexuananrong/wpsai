...
<div id="agc-license-interstitial" class="<?php echo esc_attr( $classname ); ?>">
    <div class="interstitial-content">
        <div class="heading">
            <img src="<?php echo esc_url( $this->_constants->IMAGES_ROOT_URL . 'acfw-logo.png' ); ?>" alt="ACFW logo" />
        </div>

        <h2 class="title"><em><?php esc_html_e( 'Urgent!', 'advanced-gift-cards-for-woocommerce' ); ?></em> <?php echo wp_kses_post( $title ); ?></h2>
        ...
        <div class="sub-actions">
            ...
            <?php if ( $show_refresh_license ) : ?>
                ...
                <a class="refresh-license-status" href="#"><?php esc_attr_e( 'Refresh license status', 'advanced-gift-cards-for-woocommerce' ); ?></a>
            <?php endif; ?>
        </div>
