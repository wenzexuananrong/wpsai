 ...
 * @since 1.3.4
 */
class Total_Claimed_Gift_Cards extends Abstract_Report_Widget {
    /*
    |--------------------------------------------------------------------------
    | Class Methods
    |--------------------------------------------------------------------------
    */
    ...
    public function __construct( $report_period ) {
        ...
        $widget_name       = sprintf( '%s (%s)', __( 'Total Claimed Gift Cards', 'advanced-gift-cards-for-woocommerce' ), get_woocommerce_currency_symbol() );
        $this->key         = 'total_claimed_gift_cards';
    ...
    */
    ...
    protected function _query_report_data() {
        ...
        $this->raw_data  = $gift_card_stats['total_claimed'];
    }
