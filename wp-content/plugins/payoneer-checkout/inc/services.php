...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\AssetCustomizer\AssetProcessorInterface;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\AssetCustomizer\CachingFileTemplateAssetProcessorFactoryInterface;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Cache\FileCacheFactoryInterface;
...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Filesystem\PathResolverWrappingUrlResolver;
...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Filesystem\NativeHashContextFactory;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Filesystem\NativeHasher;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Filesystem\PathResolverInterface;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Filesystem\PrefixMatchingPathResolverFactoryInterface;
...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Api\BasicTokenProvider;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Api\PayoneerFactory;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Api\PayoneerFactoryInterface;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Client\ClientFactory;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Client\ClientFactoryInterface;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Template\PathTokenTemplateFactory;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Template\StreamingPlaceholderTemplateFactory;
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Template\StreamTemplateFactoryInterface;
...
return static function (string $rootPath) : array {
    return [
        ...
        'core.assets.dirname' => new Value('assets'),
        'core.assets.path' => new Factory(['core.module.root_path', 'core.assets.dirname'], static function (string $rootPath, string $dirname) : string {
            return "{$rootPath}/{$dirname}";
        }),
        'core.assets.url' => new Factory(['core.module.root_url', 'core.uri.factory', 'core.assets.dirname'], static function (UriInterface $rootUrl, UriFactoryInterface $uriFactory, string $dirname) : UriInterface {
            return $uriFactory->createUri("{$rootUrl}/{$dirname}");
        }),
        'core.assets.generated.dirname' => new Value('generated'),
        'core.assets.generated.path' => new Factory(['core.assets.path', 'core.assets.generated.dirname'], static function (string $rootPath, string $dirname) : string {
            return "{$rootPath}/{$dirname}";
        }),
        'core.assets.css.websdk.url' => new Alias('websdk.assets.css.websdk.url'),
        'core.assets.js.websdk.url' => new Alias('websdk.assets.js.websdk.url'),
        'core.assets.css.widget.css' => new Alias('websdk.assets.css.widget.url'),
        ...
        'core.assets.generated.url' => new Factory(['core.assets.url', 'core.uri.factory', 'core.assets.generated.dirname'], static function (UriInterface $rootUrl, UriFactoryInterface $uriFactory, string $dirname) : UriInterface {
            return $uriFactory->createUri("{$rootUrl}/{$dirname}");
        }),
        'core.assets.version' => new Factory([Package::PROPERTIES], static function (Properties $properties) : string {
            return $properties->version();
        }),
        'core.http.current_url' => new Factory(['core.uri.factory'], static function (UriFactoryInterface $factory) : UriInterface {
        ...
        'core.http.settings_url' => new Factory(['core.uri.factory'], static function (UriFactoryInterface $factory) : UriInterface {
            $product = $factory->createUri(\sprintf('%s?%s', \admin_url('admin.php'), \http_build_query(['page' => 'wc-settings', 'tab' => 'checkout', 'section' => 'payoneer-checkout'])));
            return $product;
        }),
        ...
        'core.merchant_division' => new Alias('inpsyde_payment_gateway.merchant_division'),
        ...
        'core.settings_option_key' => new Alias('inpsyde_payment_gateway.settings_option_key'),
        ...
        'core.order_based_update_command_factory' => new Alias('inpsyde_payment_gateway.update_command_factory'),
        ...
        # Essential factories
        # =================================================================
        'core.file_stream.factory' => new Alias('filesystem.file_stream.factory'),
        'core.string_stream.factory' => new Alias('filesystem.string_stream.factory'),
        'core.uri.factory' => new Alias('filesystem.uri.factory'),
        'core.file_cache.factory' => new Alias('cache.base_dir_file_cache.factory'),
        'core.style_factory' => new Alias('payoneer_sdk.style_factory'),
        'core.wc_order_based_callback_factory' => new Alias('inpsyde_payment_gateway.wc_order_based_callback_factory'),
        'core.wc_order_based_customer_factory' => new Alias('inpsyde_payment_gateway.wc_order_based_customer_factory'),
        'core.wc_order_based_products_factory' => new Alias('inpsyde_payment_gateway.wc_order_based_products_factory'),
        'core.wc_order_based_payment_factory' => new Alias('inpsyde_payment_gateway.wc_order_based_payment_factory'),
        ...
        'core.security_header_factory' => new Alias('inpsyde_payment_gateway.security_header_factory'),
        'core.wc.countries' => new Alias('wc.countries'),
        'core.state_provider' => new Alias('checkout.state_provider'),
        # core.path_resolver
        # =================================================================
        'core.path_resolver.factory' => new Alias('filesystem.prefix_matching_path_resolver.factory'),
        'core.path_resolver' => new Factory(['core.path_resolver.factory', 'core.path_resolver.mappings', 'core.path_resolver.base_path'], static function (PrefixMatchingPathResolverFactoryInterface $factory, array $mappings, string $basePath) : PathResolverInterface {
            /** @var array<string, string> $mappings */
            $product = $factory->createPathResolverFromMappings($mappings, $basePath);
            return $product;
        }),
        'core.path_resolver.mappings' => new Factory(['core.module.name', 'core.module.root_path'], static function (string $moduleName, string $moduleRootPath) : array {
            return ["{$moduleName}/" => "{$moduleRootPath}/"];
        }),
        'core.path_resolver.base_path' => new Value(''),
        # core.url_resolver
        # =================================================================
        'core.url_resolver.mappings' => new Factory(['core.module.root_path', 'core.module.root_url'], static function (string $rootPath, UriInterface $rootUrl) : array {
            return ["{$rootPath}/" => "{$rootUrl}/"];
        }),
        'core.url_resolver.path_resolver.factory' => new Alias('core.path_resolver.factory'),
        'core.url_resolver.path_resolver.mappings' => new Alias('core.url_resolver.mappings'),
        'core.url_resolver.path_resolver.base_dir' => new Value(''),
        'core.url_resolver.path_resolver' => new Factory(['core.url_resolver.path_resolver.factory', 'core.url_resolver.path_resolver.mappings', 'core.url_resolver.path_resolver.base_dir'], static function (PrefixMatchingPathResolverFactoryInterface $factory, array $mappings, string $baseDir) : PathResolverInterface {
            /** @var array<string, string> $mappings */
            $product = $factory->createPathResolverFromMappings($mappings, $baseDir);
            return $product;
        }),
        'core.url_resolver.uri_factory' => new Alias('core.uri.factory'),
        'core.uri_resolver.default_protocol' => new Value('file'),
        'core.url_resolver' => new Constructor(PathResolverWrappingUrlResolver::class, ['core.url_resolver.path_resolver', 'core.url_resolver.uri_factory', 'core.uri_resolver.default_protocol']),
        ...
        # --------------------------
        'inpsyde_payment_gateway.module_url' => new Factory(['core.module.root_url', 'core.local_modules_directory_name', 'core.uri.factory'], static function (UriInterface $rootUrl, string $modulesDirName, UriFactoryInterface $factory) : UriInterface {
            $url = \sprintf('%1$s/%2$s/payment-gateway', (string) $rootUrl, $modulesDirName);
            $product = $factory->createUri($url);
            return $product;
        }),
        'inpsyde_payment_gateway.options' => new Factory(
            ['wp.sites.current.options', 'inpsyde_payment_gateway.default_options', 'inpsyde_payment_gateway.settings_option_key', 'core.data.structure_based_factory'],
        ...
        'inpsyde_payment_gateway.default_options' => new Factory(['payoneer_sdk.remote_api_url.base_string.live', 'payoneer_sdk.remote_api_url.base_string.sandbox', 'inpsyde_payment_gateway.live_merchant_id', 'inpsyde_payment_gateway.sandbox_merchant_id'], static function (string $liveUrl, string $sandboxUrl, int $liveMerchantId, int $sandboxMerchantId) : array {
            return ['live_mode' => 'no', 'merchant_id' => $liveMerchantId, 'base_url' => $liveUrl, 'label' => \__('live', 'payoneer-checkout'), 'sandbox_merchant_id' => $sandboxMerchantId, 'sandbox_base_url' => $sandboxUrl, 'sandbox_label' => \__('sandbox', 'payoneer-checkout')];
        }),
        ...
        'core.token_provider' => new Factory(['inpsyde_payment_gateway.merchant_code', 'inpsyde_payment_gateway.merchant_token'], static function (?string $username, ?string $password) : TokenAwareInterface {
        ...
        'core.payment_fields_container_id' => static function (ContainerInterface $container) : string {
            return (string) $container->get('inpsyde_payment_gateway.payment_fields_container_id');
        },
        ...
        'core.payment_gateway' => static function (ContainerInterface $container) : \WC_Payment_Gateway {
            /** @var WC_Payment_Gateway */
            return $container->get('inpsyde_payment_gateway.gateway');
        },
        'core.wc_ajax_url' => new Alias('wc.ajax_url'),
        'core.wc_product_serializer' => new Alias('inpsyde_payment_gateway.wc_product_serializer'),
        ...
        # core.hasher
        # =================================================================
        'core.hasher.factory.max_buffer_size' => new Value(1 * 1000),
        // 1MB
        'core.hasher' => new Constructor(NativeHasher::class, ['core.hasher.context.factory', 'core.hasher.factory.max_buffer_size']),
        'core.hasher.factory.algo' => new Value('sha1'),
        'core.hasher.context.factory' => new Constructor(NativeHashContextFactory::class, ['core.hasher.factory.algo']),
        # core.css_template
        # =================================================================
        'core.css_template.token_start' => new Value('/*{{'),
        'core.css_template.token_end' => new Value('}}*/'),
        'core.css_template.token_default' => new Value('initial'),
        # core.css_stream_template
        # =================================================================
        'core.css_stream_template.string_stream.factory' => new Alias('core.string_stream.factory'),
        'core.css_stream_template.token_start' => new Alias('core.css_template.token_start'),
        'core.css_stream_template.token_end' => new Alias('core.css_template.token_end'),
        'core.css_stream_template.token_default' => new Alias('core.css_template.token_default'),
        'core.css_stream_template.factory' => new Alias('core.stream_template.factory'),
        'core.stream_template.factory' => new Constructor(StreamingPlaceholderTemplateFactory::class, [
        ...
        # =================================================================
        'core.css_path_template.factory.file_stream_factory' => new Alias('core.file_stream.factory'),
        'core.css_path_template.factory.stream_template_factory' => new Alias('core.css_stream_template.factory'),
        'core.css_path_template.factory' => new Constructor(PathTokenTemplateFactory::class, ['core.css_path_template.factory.file_stream_factory', 'core.css_path_template.factory.stream_template_factory']),
        # core.css_file_processor
        # =================================================================
        'core.css_file_processor.factory' => new Alias('core.asset.template.processor.factory'),
        'core.css_file_processor.path_resolver' => new Alias('core.path_resolver'),
        'core.css_file_processor.url_resolver' => new Alias('core.url_resolver'),
        'core.css_file_processor.file_cache.factory' => new Alias('core.file_cache.factory'),
        'core.css_file_processor.file_cache.base_dir' => new Alias('core.assets.generated.path'),
        'core.css_file_processor.file_cache' => new Factory(['core.css_file_processor.file_cache.factory', 'core.css_file_processor.file_cache.base_dir'], static function (FileCacheFactoryInterface $factory, string $baseDir) : FileCacheInterface {
            $product = $factory->createFileCacheFromBaseDir($baseDir);
            return $product;
        }),
        'core.css_file_processor' => new Factory(['core.css_file_processor.factory', 'core.css_file_processor.path_resolver', 'core.css_file_processor.url_resolver', 'core.css_file_processor.file_cache'], static function (CachingFileTemplateAssetProcessorFactoryInterface $factory, PathResolverInterface $pathResolver, UrlResolverInterface $urlResolver, FileCacheInterface $fileCache) : AssetProcessorInterface {
            $product = $factory->createFileAssetProcessor($pathResolver, $urlResolver, $fileCache);
            return $product;
        }),
        # core.webhooks
        # =================================================================
        ...
        'core.payment_gateway.transaction_url_template' => new Factory(['inpsyde_payment_gateway.string_stream.factory', 'inpsyde_payment_gateway.stream_template.factory'], static function (StringStreamFactoryInterface $streamFactory, StreamTemplateFactoryInterface $templateFactory) : TemplateInterface {
        ...
        'core.payment_gateway.is_enabled' => new Alias('inpsyde_payment_gateway.is_enabled'),
        # Module wiring
        # =================================================================
        ## cache
        # --------------------------
        'cache.hasher' => new Alias('core.hasher'),
        'cache.string_stream.factory' => new Alias('core.string_stream.factory'),
        'cache.file_stream.factory' => new Alias('core.file_stream.factory'),
        ## assets
        # --------------------------
        'assets.hasher' => new Alias('core.hasher'),
        'assets.file_stream.factory' => new Alias('core.file_stream.factory'),
        'assets.path_template.factory' => new Alias('core.css_path_template.factory'),
        'core.asset.template.processor.factory' => new Alias('assets.caching_file_template.processor.factory'),
        ## checkout
        # --------------------------
        'checkout.asset_processor' => new Alias('core.css_file_processor'),
        ...
        'checkout.list_session_manager.cache_key.salt.update_on_events' => new Factory(['inpsyde_payment_gateway.gateway.id'], static function (string $gatewayId) : array {
        ...
        'inpsyde_payment_gateway.merchant_id_field_name' => new Alias('core.payment_gateway.order.merchant_id_field_name'),
        ...
        'inpsyde_payment_gateway.not_supported_countries' => new Alias('core.payment_gateway.not_supported_countries'),
        ...
        'inpsyde_payment_gateway.assets.version' => new Alias('core.assets.version'),
        'inpsyde_payment_gateway.string_stream.factory' => new Alias('filesystem.string_stream.factory'),
        'inpsyde_payment_gateway.stream_template.factory' => new Alias('core.stream_template.factory'),
        'payment_gateway.transaction_url_template' => new Alias('core.payment_gateway.transaction_url_template'),
        ...
        ## embedded_payment
        # --------------------------
        'embedded_payment.assets.css.websdk.url' => new Alias('core.assets.css.websdk.url'),
        'embedded_payment.assets.js.websdk.url' => new Alias('core.assets.js.websdk.url'),
        'embedded_payment.assets.widget.css_url' => new Alias('core.assets.css.widget.css'),
        'embedded_payment.gateway.gateway' => new Alias('core.payment_gateway'),
        ...
        'migration.payment_gateway' => new Alias('core.payment_gateway'),
        'migration.embedded_payment.custom_css.default' => new Alias('core.embedded_payment.custom_css.default'),
        ## admin_banner
        # --------------------------
        ...
        ## mor
        # --------------------------
        'mor.product_tax_code_field_name' => new Alias('core.product_tax_code_field_name'),
        'mor.product_tax_code_format' => new Value('[A-Za-z0-9]{2,20}'),
        'mor.product_tax_code_field_title' => new Value(\__('Tax code must contain 2-20 characters. Only latin letters and digits are allowed.', 'payoneer-checkout')),
        ## taxes
        # --------------------------
        'taxes.is_checkout' => new Alias('core.is_checkout'),
    ];
};
