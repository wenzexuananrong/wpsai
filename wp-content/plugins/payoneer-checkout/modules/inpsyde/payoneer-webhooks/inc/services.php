...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\Webhooks\OrderSecurityValidator\OrderSecurityValidator;
...
return static function () : array {
    ...
    return [
        ...
        'webhooks.order_finder' => new Constructor(OrderFinder::class, ['webhooks.order.transaction_id_field_name']),
        ...
        'webhooks.order_security_validator' => new Constructor(OrderSecurityValidator::class, ['webhooks.order.security_header_field_name']),
