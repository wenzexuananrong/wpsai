...
return static function () : array {
    return ['payoneer_sdk.remote_api_url.base_string' => static function () : string {
        ...
        return new ListDeserializer($listFactory, $callbackDeserializer, $customerDeserializer, $paymentDeserializer, $statusDeserializer, $redirectDeserializer, $identificationDeserializer, $styleDeserializer, $productDeserializer, $processingModelDeserializer);
        ...
        return new ListSerializer($identificationSerializer, $paymentSerializer, $statusSerializer, $customerSerializer, $styleSerializer, $redirectSerializer, $productSerializer, $processingModelSerializer);
