...
return static function () : array {
    return [
        ...
        'inpsyde_payment_gateway.payment_request_validator' => static function (PaymentRequestValidatorInterface $previous, ContainerInterface $container) : PaymentRequestValidatorInterface {
        ...
        'checkout.payment_field_renderers' => static function (array $renderers, ContainerInterface $container) : array {
            ...
            $placeholderRenderer = $container->get('embedded_payment.payment_fields_renderer.placeholder');
            \assert($placeholderRenderer instanceof WidgetPlaceholderFieldRenderer);
            $checkoutHashRenderer = $container->get('embedded_payment.payment_fields_renderer.list_hash');
