...
class WidgetPlaceholderFieldRenderer implements PaymentFieldsRendererInterface
{
     ...
     *          payment fields.
     */
    public function __construct(string $paymentFieldsContainerId)
    {
    ...
    public function renderFields() : string
    {
        ...
        return sprintf('<div id="%1$s"><p>%2$s</p></div>', esc_attr($this->paymentFieldsContainerId), __('Payment will be done on a dedicated payment page', 'payoneer-checkout'));
    }
}
