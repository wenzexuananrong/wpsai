...
class ListUrlFieldRenderer implements PaymentFieldsRendererInterface
{
    ...
    public function __construct(ListSessionProvider $listSessionProvider, string $listUrlContainerId, string $listUrlContainerAttributeName)
    {
    ...
    public function renderFields() : string
    {
        ...
        $listIdContainer = sprintf('<input type="hidden" name="%1$s" id="%1$s" value="%2$s">', esc_attr($this->listUrlContainerId), esc_url_raw($listSessionUrl));
