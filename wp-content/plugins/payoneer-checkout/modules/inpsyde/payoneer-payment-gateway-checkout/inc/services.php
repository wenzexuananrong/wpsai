...
use Syde\Vendor\Inpsyde\PayoneerForWoocommerce\PaymentGateway\Gateway\GatewayIconsRenderer\GatewayIconsRendererInterface;
...
return static function () : array {
    return [
        ...
        'checkout.list_session_manager.cache_key.checkout' => new StringService('payoneer_list_checkout_{0}', ['checkout.list_session_manager.cache_key.salt']),
        'checkout.list_session_manager.cache_key.payment' => new StringService('payoneer_list_pay_{0}_{1}', ['wc.pay_for_order_id', 'checkout.list_session_manager.cache_key.salt']),
        'checkout.list_session_manager.cache_key' => static function (ContainerInterface $container) : string {
        ...
        'checkout.css_assets_relative_path' => new Factory(['core.local_modules_directory_name', 'checkout.module_directory_name'], static function (string $modulesDirectoryRelativePath, string $moduleDirectoryName) : string {
        ...
        'checkout.templates_dir_virtual_path' => new StringService('{module_name}/static/templates', ['module_name' => 'checkout.module_name']),
        'checkout.module_path' => new Value(dirname(__FILE__, 2)),
        'checkout.templates_dir_local_path' => new StringService('{module_path}/static/templates', ['module_path' => 'checkout.module_path']),
        'checkout.security_token_generator' => new Constructor(TokenGenerator::class),
        'checkout.transaction_id_generator' => new Constructor(TransactionIdGenerator::class),
        'checkout.checkout_hash_provider' => new Constructor(CheckoutHashProvider::class, ['wc']),
        'checkout.misconfiguration_detector' => new Constructor(MisconfigurationDetector::class),
        'checkout.gateway_icon_elements_css' => new Value(<<<CSS
...
CSS
        ...
        'checkout.gateway_icon_elements_filenames' => new Factory(['checkout.amex_icon_enabled', 'checkout.jcb_icon_enabled'], static function (bool $amexEnabled, bool $jcbEnabled) : array {
            $icons = ['visa.svg', 'mastercard.svg'];
            if ($amexEnabled) {
        ...
        'checkout.amex_settings_field' => Service::fromFile(__DIR__ . '/amex_icon_setting_field.php'),
        'checkout.jcb_settings_field' => Service::fromFile(__DIR__ . '/jcb_icon_setting_field.php'),
        'checkout.gateway_icon_elements' => static function (ContainerInterface $container) : array {
        ...
        'checkout.gateway_icons_renderer' => static function (ContainerInterface $container) : GatewayIconsRendererInterface {
        ...
        'checkout.settings.general_settings_fields' => Service::fromFile(__DIR__ . "/general_settings_fields.php"),
        'checkout.settings.appearance_settings_fields' => Service::fromFile(__DIR__ . "/appearance_settings_fields.php"),
        'checkout.on_error_refresh_fragment_flag' => new Value('payoneer_refresh_fragment_onError'),
        'checkout.is_on_error_refresh_fragment_flag' => new Factory(['checkout.on_error_refresh_fragment_flag'], static function (string $onErrorFlag) : bool {
            /**
        ...
        'checkout.payment_flow_override_flag.is_set' => new Factory(['checkout.payment_flow_override_flag'], static function (string $forceHostedFlowFlag) : bool {
         ...
         *
         */
        'inpsyde_payment_gateway.payment_fields_renderer' => new Factory(['checkout.payment_field_renderers'], static function (array $renderers) : CompoundPaymentFieldsRenderer {
            /**
        ...
        'checkout.notification_received' => new Factory(['checkout.notification_received.option_name'], static function (string $optionName) : bool {
            return get_option($optionName) === 'yes';
        }),
        'checkout.notification_received.option_name' => new Value('payoneer-checkout-notification-received'),
        'checkout.state_provider' => new Constructor(StateProvider::class, ['checkout.wc.countries']),
        'inpsyde_payment_gateway.is_live_mode' => new Factory(['inpsyde_payment_gateway.options'], static function (ContainerInterface $options) : bool {
        ...
        'checkout.product_tax_code_field_name' => new Value('_payoneer-checkout_tax-code'),
        'checkout.default_product_tax_code' => new Value(null),
        'checkout.product_tax_code_provider' => new Constructor(ProductTaxCodeProvider::class, ['checkout.product_tax_code_field_name', 'checkout.default_product_tax_code']),
        'checkout.jcb_icon_enabled' => new Factory(['checkout.payment_gateway_options'], static function (ContainerInterface $options) : bool {
