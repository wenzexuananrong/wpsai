<?php
namespace LPFW\Models\SLMW\Traits;
...
trait Notices {
    ...
    */
    ...
    public function display_no_license_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'       => 'lpfw-no-license-interstitial',
                'title'           => __( 'Your Loyalty Program license is missing!', 'loyalty-program-for-woocommerce' ),
                'action_url'      => $this->_constants->get_license_page_url(),
                'action_text'     => __( 'Enter Licenses Now', 'loyalty-program-for-woocommerce' ),
                'sub_action_url'  => $this->_add_drm_query_args( 'https://advancedcouponsplugin.com/pricing/', 'interstitialpurchaselink' ),
                'sub_action_text' => __( 'Don’t have a license yet? Purchase here.', 'loyalty-program-for-woocommerce' ),
            )
        );
    }
    ...
    */
    ...
    public function display_disabled_license_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'       => 'lpfw-disabled-license-interstitial',
                'title'           => __( 'Your Loyalty Program license is disabled!', 'loyalty-program-for-woocommerce' ),
                'action_url'      => $this->_add_drm_query_args( 'http://advancedcouponsplugin.com/my-account/pricing/', 'disabledinterstitial' ),
                'action_text'     => __( 'Repurchase New License', 'loyalty-program-for-woocommerce' ),
                'sub_action_url'  => $this->_constants->get_license_page_url(),
                'sub_action_text' => __( 'Enter a new license', 'loyalty-program-for-woocommerce' ),
            )
        );
    }
    ...
    */
    ...
    public function display_post_expiry_interstitial() {
        ...
        $this->_display_interstitial(
            array(
                'classname'            => 'lpfw-license-expired-interstitial',
                'title'                => __( 'Your Loyalty Program license has expired!', 'loyalty-program-for-woocommerce' ),
                ...
                'action_text'          => __( 'Renew License', 'loyalty-program-for-woocommerce' ),
                'sub_action_url'       => $this->_constants->get_license_page_url(),
                'sub_action_text'      => __( 'Enter a new license', 'loyalty-program-for-woocommerce' ),
    ...
    public function ajax_dismiss_license_notice() {
        ...
        $post_data = $this->_helper_functions->validate_ajax_request(
            array(
                ...
                'nonce_action'        => 'lpfw_dismiss_license_notice',
    ...
    private function _display_interstitial( $args ) {
        ...
        $args             = wp_parse_args(
            ...
            array(
                'classname'            => '',
                'title'                => '',
                'description'          => __( 'Without an active license, your loyalty points in the front end will still continue to work, but premium functionality has been disabled until a valid license is entered.', 'loyalty-program-for-woocommerce' ),
                'action_url'           => '',
                'action_text'          => '',
                'sub_action_url'       => '',
                'sub_action_text'      => '',
