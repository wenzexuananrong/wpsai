    ...
    */
    ...
    private function register_scripts() {
        ...
        $vite_app = new Vite_App(
            'lpfw-wc-cart-block-integration', // Don't forget to register this handle in the get_script_handles() or get_editor_script_handles() method.
            'packages/lpfw-cart-block/index.tsx',
        );
        $vite_app->register();
    }
    ...
    public function get_script_handles() {
        return array( 'lpfw-wc-cart-block-integration' );
    }
