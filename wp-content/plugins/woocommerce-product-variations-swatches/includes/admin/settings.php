...
class VIWPVS_WOOCOMMERCE_PRODUCT_VARIATIONS_SWATCHES_Admin_Settings {
	...
	public function settings_callback() {
		...
		$product_list_expand_attributes_enable  = $this->settings->get_params( 'product_list_expand_attributes_enable' );
		...
		$product_list_slider_min                = $this->settings->get_params( 'product_list_slider_min' ) ?: '';
		$single_product_list_slider             = $this->settings->get_params( 'single_product_list_slider' );
		$single_product_list_slider_type        = $this->settings->get_params( 'single_product_list_slider_type' ) ?: array();
		$single_product_list_slider_min         = $this->settings->get_params( 'single_product_list_slider_min' ) ?: 3;
        ...
        <div class="wrap">
            ...
            <div class="vi-ui raised">
                <form class="vi-ui form" method="post" enctype="multipart/form-data">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">
                                        <strong><?php esc_html_e( '*Important: ', 'woocommerce-product-variations-swatches' ); ?></strong><?php esc_html_e( 'To make out-of-stock items clickable, you have to turn off "Disable \'out of stock\' variation items" option', 'woocommerce-product-variations-swatches' ); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="vi-ui bottom attached tab segment active vi-wpvs-tab-swatches_profile" data-tab="swatches_profile">
                    ...
                    <div class="vi-ui bottom attached tab segment vi-wpvs-tab-single_page" data-tab="single_page">
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wpvs-single-product_list_slider-checkbox">
										<?php esc_html_e( 'Single Swatches slider', 'woocommerce-product-variations-swatches' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="hidden" name="single_product_list_slider" id="vi-wpvs-single_product_list_slider"
                                               value="<?php echo esc_attr( $single_product_list_slider ); ?>">
                                        <input type="checkbox" class="vi-wpvs-single_product_list_slider-checkbox"
                                               id="vi-wpvs-single_product_list_slider-checkbox" <?php checked( $single_product_list_slider, '1' ); ?>>
                                        <label for="vi-wpvs-single_product_list_slider-checkbox"><?php esc_html_e( 'Enable', 'woocommerce-product-variations-swatches' ); ?></label>
                                    </div>
                                    <p class="description">
                            ...
                            <tr class="vi-wpvs-single_product_list_slider-enable <?php echo $single_product_list_slider ? '' : esc_attr( 'vi-wpvs-hidden' ); ?>">
                                <th>
                                    <label for="vi-wpvs-single_product_list_slider_type">
										<?php esc_html_e( 'Swatches slider for attribute type', 'woocommerce-product-variations-swatches' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <select name="single_product_list_slider_type[]" id="vi-wpvs-single_product_list_slider_type"
                                            class="vi-ui fluid dropdown vi-wpvs-product_list_slider_type" multiple>
                                        <option value="color" <?php selected( in_array( 'color', $single_product_list_slider_type ), true ) ?>>
											<?php esc_html_e( 'Color', 'woocommerce-product-variations-swatches' ); ?>
                                        </option>
                                        <option value="image" <?php selected( in_array( 'image', $single_product_list_slider_type ), true ) ?>>
											<?php esc_html_e( 'Image', 'woocommerce-product-variations-swatches' ); ?>
                                        </option>
                                        <option value="variation_img" <?php selected( in_array( 'variation_img', $single_product_list_slider_type ), true ) ?>>
                            ...
                            <tr class="vi-wpvs-single_product_list_slider-enable <?php echo $single_product_list_slider ? '' : esc_attr( 'vi-wpvs-hidden' ); ?>">
                                <th>
                                    <label for="vi-wpvs-single_product_list_slider_min">
										<?php esc_html_e( 'Minimum attribute items', 'woocommerce-product-variations-swatches' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <input type="number" name="single_product_list_slider_min" min="3" step="1"
                                           id="vi-wpvs-single_product_list_slider_min"
                                           value="<?php echo esc_attr( $single_product_list_slider_min ); ?>">
                                    <p class="description">
										<?php esc_html_e( 'The minimum number of items of an attribute to convert to slider', 'woocommerce-product-variations-swatches' ); ?>
                                    </p>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="vi-ui bottom attached tab segment vi-wpvs-tab-product_list" data-tab="product_list">
                        <table class="form-table">
                            ...
                            <tr class="vi-wpvs-product-list-more-link-enable <?php echo $product_list_more_link_enable ? '' : esc_attr( 'vi-wpvs-hidden' ); ?>">
                                <th>
                                    <label for="vi-wpvs-product-list-expand-attributes-checkbox">
										<?php esc_html_e( 'Expand attributes', 'woocommerce-product-variations-swatches' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="hidden" name="product_list_expand_attributes_enable"
                                               class="vi-wpvs-product_list_expand_attributes_enable"
                                               value="<?php echo esc_attr( $product_list_expand_attributes_enable ); ?>">
                                        <input type="checkbox" id="vi-wpvs-product-list-expand-attributes-checkbox"
                                               class="vi-wpvs-product-list-expand-attributes-checkbox" <?php checked( $product_list_expand_attributes_enable, '1' ); ?>>

                                        <label for="vvi-wpvs-product-list-expand-attributes-checkbox">
											<?php esc_html_e( 'Enable', 'woocommerce-product-variations-swatches' ); ?>
                                        </label>
                                    </div>
                                    <p class="description">
										<?php esc_html_e( 'Click to view all attributes instead of redirecting to single product page.', 'woocommerce-product-variations-swatches' ); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr class="vi-wpvs-product-list-more-link-enable <?php echo $product_list_more_link_enable ? '' : esc_attr( 'vi-wpvs-hidden' ); ?>">
	...
	public function save_settings() {
		...
		if ( isset( $_POST['vi-wpvs-save'] ) || isset( $_POST['vi-wpvs-check_key'] ) ) {
			$map_args_1 = array(
				...
				'single_product_list_slider_type',
			);
			$map_args_2 = array(
				...
				'product_list_expand_attributes_enable',
				'product_list_maximum_more_link_text',
				'product_list_slider',
				'product_list_slider_min',
				'single_product_list_slider',
				'single_product_list_slider_min',
