jQuery(document).ready(function ($) {
    ...
    window.woocommerce_multi_currency = {
        ...
        design: function () {
            ...
            jQuery('.wmc-curusd').on('click',function(){jQuery('.woocommerce-multi-currency.wmc-sidebar').toggleClass('wmc-hover')});
            if (windowsize <= 768) {
                ...
                success(res) {
                    if (res.success) {
                        ...
                        if (currentCurrency) {
                            ...
                            $('.pcwmc-curusd').html(currentCurrency+'<span class="wd-btn-icon"><img width="36" height="36" src="https://d7bimqy5wbg0.cloudfront.net/web/asset/common/'+currentCurrency+'.svg" class="attachment- size-" decoding="async" loading="eager"></span>');
                            $('.mobwmc-curusd').html('<a href="#" class="woodmart-nav-link"><img loading="lazy" src="https://d7bimqy5wbg0.cloudfront.net/web/asset/common/'+currentCurrency+'.svg" class="wd-nav-img" width="18" height="18"><span class="nav-link-text">'+currentCurrency+'</span></a>');
                        }
        ...
        overrideSwitcher() {
            ...
            $('.wmc-curusd').html(currentCurrency+'<span class="wd-btn-icon"><img width="36" height="36" src="https://d7bimqy5wbg0.cloudfront.net/web/asset/common/'+currentCurrency+'.svg" class="attachment- size-" decoding="async" loading="eager"></span>');
