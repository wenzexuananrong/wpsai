jQuery(document).ready(function ($) {
     ...
     */
    $('.woo-orders-tracking-export-preview-container').on('click', function () {
        $(this).addClass('woo-orders-tracking-hidden');
    });
    $('.woo-orders-tracking-export-preview').on('click', function (e) {
        e.stopPropagation();
    });
    $('.woo-orders-tracking-export-order-button-preview').on('click', function () {
        let $button = $(this);
        let $preview = $('.woo-orders-tracking-export-preview-container');
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function () {
                $('.woo-orders-tracking-export-preview table').html('');
            },
            error: function (err) {
            },
            success: function (response) {
                ...
                if (response.status === 'success') {
                    $('.woo-orders-tracking-export-preview table').replaceWith($(response.preview));
                    $preview.removeClass('woo-orders-tracking-hidden');
                }
            },
            complete: function () {
