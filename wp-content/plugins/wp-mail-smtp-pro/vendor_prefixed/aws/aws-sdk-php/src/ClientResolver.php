...
class ClientResolver
{
    ...
    public static function _apply_credentials($value, array &$args)
    {
        ...
        if ($value instanceof \WPMailSMTP\Vendor\Aws\Credentials\CredentialsInterface) {
            ...
            $args['credentials'] = \WPMailSMTP\Vendor\Aws\Credentials\CredentialProvider::fromCredentials(new \WPMailSMTP\Vendor\Aws\Credentials\Credentials($value['key'], $value['secret'], isset($value['token']) ? $value['token'] : null, isset($value['expires']) ? $value['expires'] : null));
        } elseif ($value === \false) {
    ...
    public static function _apply_token($value, array &$args)
    {
        ...
        if ($value instanceof \WPMailSMTP\Vendor\Aws\Token\Token) {
            ...
            $args['token'] = \WPMailSMTP\Vendor\Aws\Token\TokenProvider::fromToken(new \WPMailSMTP\Vendor\Aws\Token\Token($value['token'], isset($value['expires']) ? $value['expires'] : null));
        } elseif ($value instanceof \WPMailSMTP\Vendor\Aws\CacheInterface) {
