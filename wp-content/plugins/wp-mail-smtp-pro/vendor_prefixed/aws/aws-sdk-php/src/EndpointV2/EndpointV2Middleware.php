...
class EndpointV2Middleware
{
     ...
     * @return Closure
     */
    public static function wrap(\WPMailSMTP\Vendor\Aws\EndpointV2\EndpointProviderV2 $endpointProvider, \WPMailSMTP\Vendor\Aws\Api\Service $api, array $args) : \Closure
    {
     ...
     * @param array $args
     */
    public function __construct(callable $nextHandler, \WPMailSMTP\Vendor\Aws\EndpointV2\EndpointProviderV2 $endpointProvider, \WPMailSMTP\Vendor\Aws\Api\Service $api, array $args)
    {
