...
class Marquee extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wd-marquee .wd-marquee-icon' => 'color: {{VALUE}}',
				),
				'condition' => array(
					'icon_type' => array( 'icon' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wd-marquee .wd-marquee-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'icon_type' => array( 'icon' ),
				),
	...
	protected function render() {
		...
		if ( 'image' === $settings['icon_type'] && ! empty( $settings['image']['id'] ) ) {
			...
			$icon_output = woodmart_elementor_get_render_icon( $settings['icon'], array( 'class' => 'wd-marquee-icon' ) );
		}
