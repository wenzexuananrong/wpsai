...
if ( ! function_exists( 'woocommerce_shop_laminate_image_loop' ) ) {
    function woocommerce_shop_laminate_image_loop()
    {
        $img_url = get_post_meta( get_the_ID(), 'laminate_image', true );
        if(is_array($img_url)){
            echo "<span class='laminate_image' style='position: absolute;left:0px;bottom:0px;'><img src='{$img_url['url']} '/></span>";
        }
    }
}
add_action( 'woocommerce_shop_laminate_image', 'woocommerce_shop_laminate_image_loop', 20 );
