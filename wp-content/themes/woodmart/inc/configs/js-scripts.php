...
return array(
    ...
    'curr_product_cat'                     => array(
        array(
            'title'     => esc_html__( 'curr_product_cat', 'woodmart' ),
            'name'      => 'curr_product_cat',
            'file'      => '/js/scripts/wc/curr_product_cat',
            'in_footer' => true,
        ),
    ),
    'product-delivery-time'                     => array(
        array(
            'title'     => esc_html__( 'product-delivery-time', 'woodmart' ),
            'name'      => 'product-delivery-time',
            'file'      => '/js/scripts/wc/productDeliveryTme',
            'in_footer' => true,
        ),
    ),
);
