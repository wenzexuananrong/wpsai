...
if ( ! function_exists( 'woodmart_register_product_metaboxes' ) ) {
	...
	function woodmart_register_product_metaboxes() {
        ...
        $product_metabox->add_section(
            array(
                'id'       => 'tab_options_advertising',
                'name'     => esc_html__( '产品叠层图片', 'woodmart' ),
                'icon'     => 'xts-i-footer',
                'priority' => 50,
            )
        );
        $product_metabox->add_section(
            array(
                'id'       => 'delay_the_delivery',
                'name'     => esc_html__( '延迟发货', 'woodmart' ),
                'icon'     => 'xts-i-footer',
                'priority' => 52,
            )
        );
        $product_metabox->add_section(
            array(
                'id'       => 'setting_size_guide',
                'name'     => esc_html__( '尺码表', 'woodmart' ),
                'icon'     => 'xts-i-footer',
                'priority' => 52,
            )
        );
        ...
        $product_metabox->add_field(
            array(
                ...
                'type'        => 'upload',
                'section'     => 'tab_options_advertising',
                'priority'    => 10,
            )
        );
        $product_metabox->add_field(
            array(
                'id'          => $woodmart_prefix . 'delay_the_delivery_status',
                'type'        => 'checkbox',
                'name'        => esc_html__( '延迟发货开关', 'woodmart' ),
                'hint'        => wp_kses( __( '<img data-src="' . WOODMART_TOOLTIP_URL . 'permanent-new-label.jpg" alt="">', 'woodmart' ), true ),
                'description' => '',
                'section'     => 'delay_the_delivery',
                'priority'    => 10,
                'class'       => 'xts-col-6',
            )
        );
        ...
        $product_metabox->add_field(
            array(
                'id'          => $woodmart_prefix . 'delay_the_delivery_tips',
                'type'        => 'text_input',
                'name'        => esc_html__( '延迟发货提示', 'woodmart' ),
                'hint'        => '',
                'description' => '',
                'section'     => 'delay_the_delivery',
                'priority'    => 50,
        ...
        $product_metabox->add_field(
            array(
                'id'          => $woodmart_prefix . 'delay_the_delivery_title',
                'type'        => 'text_input',
                'name'        => esc_html__( '延迟发货标题', 'woodmart' ),
                'hint'        => '',
                'description' => '',
                'section'     => 'delay_the_delivery',
                'priority'    => 51,
        ...
        $product_metabox->add_field(
            array(
                'id'           => $woodmart_prefix . 'delay_the_delivery_block',
                'name'         => esc_html__( '弹窗 block', 'woodmart' ),
                'description'  => esc_html__( 'You can create some extra content with WPBakery Page Builder (in Admin panel / HTML Blocks / Add new) and add it to this product', 'woodmart' ),
                'type'         => 'select',
                'section'      => 'delay_the_delivery',
                'select2'      => true,
        ...
        $product_metabox->add_field(
            array(
                'id'          => $woodmart_prefix . 'setting_size_guide_img',
                'type'        => 'text_input',
                'name'        => esc_html__( '尺码图图片地址', 'woodmart' ),
                'hint'        => '',
                'description' => '例如:https://dy05kmkstbu3u.cloudfront.net/cdn/c/hotpin/size/23-06/dress/JEPNF4KB/size.webp',
                'section'     => 'setting_size_guide',
                'priority'    => 51,
            )
        );
...
$product_attribute_metabox->add_field(
	array(
		'id'           => 'category_extra_description_
		html_block',
		'type'         => 'select',
		'section'      => 'general',
		'name'         => esc_html__( 'HTML Block', 'woodmart' ),
...
$product_attribute_metabox->add_field(
    array(
        'id'          => 'category_content_text',
        'name'        => esc_html__( '产品分类描述', 'woodmart' ),
        'description' => esc_html__( 'Additional category description that will be displayed after product loop on this category page.', 'woodmart' ),
        'type'        => 'textarea',
        'wysiwyg'     => true,
        'section'     => 'general',
